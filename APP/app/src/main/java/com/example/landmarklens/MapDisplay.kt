...
/**
 * Mapa con OSMDroid (OpenStreetMap nativo Android, sin WebView ni API Key)
 */
@Composable
fun MapDisplay(
    latitude: Double,
...
fun OsmMapView(
    ...
    // Marcador actualizado cuando cambian las coordenadas
    ...
    // Gestión correcta del ciclo de vida del mapa
